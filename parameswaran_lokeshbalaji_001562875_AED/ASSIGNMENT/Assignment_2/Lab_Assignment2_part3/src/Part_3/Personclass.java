   ...
   House house = new House();
    ...
    public boolean checkvitals(){
        ...
        if(p.getAgeGrup().equals("NEWBORN")){
            ...
            if(p.getEncounterhist().getEnchistory().get(0).getVitalsign().getRespiratoryrate() >= agecalculation.getRespiratoryratelow()&&
                    p.getEncounterhist().getEnchistory().get(0).getVitalsign().getRespiratoryrate() <= agecalculation.getRespiratoryratehigh()
                    &&p.getEncounterhist().getEnchistory().get(0).getVitalsign().getHeartrate() >= agecalculation.getHeartratelow() &&
                    p.getEncounterhist().getEnchistory().get(0).getVitalsign().getHeartrate() <= agecalculation.getHeartratehigh()
                    && p.getEncounterhist().getEnchistory().get(0).getVitalsign().getBloodpressure() >= agecalculation.getBloodpressurelow()&&
                    p.getEncounterhist().getEnchistory().get(0).getVitalsign().getBloodpressure() <= agecalculation.getBloodpressurehigh()
                    &&p.getEncounterhist().getEnchistory().get(0).getVitalsign().getWeightk() >= agecalculation.getWeightklow()&&
                    p.getEncounterhist().getEnchistory().get(0).getVitalsign().getWeightk() <= agecalculation.getWeightkhigh()&&
                    p.getEncounterhist().getEnchistory().get(0).getVitalsign().getWeightp() >= agecalculation.getWeightplow()&&
                    p.getEncounterhist().getEnchistory().get(0).getVitalsign().getWeightp() <= agecalculation.getWeightphigh()){
